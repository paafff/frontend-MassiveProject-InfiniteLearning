...
const Service = ({ id, name, date }) => {
    ...
    return (
        ...
        <div className='w-full py-3 px-5 border-b border-gray-200 flex justify-between gap-10' key={id}>
            <div className='w-1/4 flex flex-col gap-2 items-start'>
                <label htmlFor={id} className='text-sm md:text-base font-thin'>{name}</label>

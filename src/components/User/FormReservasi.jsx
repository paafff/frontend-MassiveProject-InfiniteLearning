...
const FormReservasi = ({ businessId, display, open, handleClose }) => {
  ...
  return (
    ...
    >
      <Box sx={style} className="w-full xl:w-1/2 md:w-3/4 md:h-[90%] xl:h-[75%] scale-50">
        <div className='w-full  '>
          <div className='w-full flex justify-end'>
            <p onClick={handleClose} className='text-lg font-bold hover:cursor-pointer hover:bg-zinc-800 hover:text-white transition-all px-3 rounded'>X</p>
          </div>
          ...
          <form onSubmit={createReservation} className='w-full lg:w-3/4 mt-10 mx-auto'>

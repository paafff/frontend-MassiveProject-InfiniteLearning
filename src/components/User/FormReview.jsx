  ...
  return (
    <div class="col-span-3">
      <div class="ml-5 mt-10 mb-2 flex flex-row">
        <img src="/src/assets/images/icons/UserList.webp" />
        ...
        <div class="px-6 py-4">
          <form>
            {/* <div class='flex flex-row my-6'>
                        ...
                        <div class='flex flex-row my-6'>
                            ...
                            <div class='flex flex-wrap basis-2/3'>
                                ...
                                <img class='mx-2' src='/src/assets/images/icons/MapPinLine.webp' />
            ...
            <div class="flex flex-roy my-6">
              <label class="w-1/3 block text-sm font-medium leading-6 text-gray-900">
                Beri nilai ulasan
              </label>
            ...
            <div class="flex justify-end mr-10 mt-10">
              <button
                class="bg-green-600 hover:bg-green-800 text-white font-bold py-2 px-5 rounded shadow-lg"
